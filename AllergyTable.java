...
public class AllergyTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/its340_finalproject/patient.png"))); // NOI18N
        ...
        btnEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/its340_finalproject/edit-text.png"))); // NOI18N
        ...
        btnNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/its340_finalproject/add.png"))); // NOI18N
        btnNew.setText("New");
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/its340_finalproject/diskette.png"))); // NOI18N
        ...
        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/its340_finalproject/delete.png"))); // NOI18N
        ...
        btnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/its340_finalproject/next_2.png"))); // NOI18N
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtAllergyStart)
                                            .addComponent(txtAllergyEnd))))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (buttonMode == 1) {
            ...
            String dbURL = "jdbc:mysql://localhost:3306/patientdata?autoReconnect=true&useSSL=false";

            try {
                conn = myconn.getConnection();
                conn = DriverManager.getConnection(dURL, "root", "");
//                int lastAllergyID = getLastInsertedAllergyID(conn);
//                int AllergyID = lastAllergyID + 1;
                int lastPatientID = getLastInsertedPatientID(conn);
                int PatientID = lastPatientID + 1;

                String sqlInsert = "INSERT INTO allergyhistorytable(PatientID, Allergen, "
                        + "AllergyStartDate, AllergyEndDate, AllergyDescription) "
                        + "VALUES(?, ?, ?, ?, ?)";

                PreparedStatement ps = conn.prepareStatement(sqlInsert);
                //ps.setInt(1, AllergyID);
                ps.setInt(1, PatientID);
                ps.setString(2, txtAllergen.getText());
                ps.setString(3, txtAllergyStart.getText());
                ps.setString(4, txtAllergyEnd.getText());
                ps.setString(5, txtAllergyDescr.getText());
                ...
                String qryStoredProc = "{CALL InsertAllergy()}";
                PreparedStatement storedProc = conn.prepareStatement(qryStoredProc);
//                storedProc.setInt(1, pid);
                ResultSet rs2 = storedProc.executeQuery();
//                ps.close();
                conn.close();
...
//                    + "AllergyDescription=?,  AllergyStartDate=?, AllergyEndDate=?,"
//                    + "WHERE AllergenID=?";
                String sqlUpdate = "UPDATE allergyhistorytable set Allergen=?, "
                        + "AllergyDescription=?"
                        + "WHERE AllergenID=?";
